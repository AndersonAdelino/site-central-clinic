            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
                    ...
                    <div className="lg:w-1/3 lg:sticky lg:top-32 lg:h-[calc(100vh-10rem)] flex flex-col pt-10">
                        ...
                        <p className="text-foreground/85 text-lg md:text-xl font-sans leading-relaxed mb-10 max-w-sm">
                        ...
                        <div className="mt-auto hidden lg:block">
                            <p className="text-sm text-foreground/75 font-bold uppercase tracking-widest mb-4">Deslize para explorar</p>
                                ...
                                {specialties.map((service, idx) => (
                                    <motion.div key={service.id} variants={itemVariants} className={idx % 2 !== 0 ? "md:mt-12" : ""}>
                                        ...
                                        >
                                            ...
                                            <p className="text-foreground/85 text-base mb-8 leading-relaxed font-sans flex-grow relative z-10">
