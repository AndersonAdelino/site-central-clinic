        ...
        <footer className="bg-gray-50 border-t border-gray-200">
            <div className="max-w-[1080px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 pt-2">
                            <a href="#" className="text-gray-700 hover:text-primary transition-colors" aria-label="Acessar Instagram da Central Clinic">
                                <Instagram className="h-5 w-5" />
                            </a>
                            <a href="#" className="text-gray-700 hover:text-primary transition-colors" aria-label="Acessar Facebook da Central Clinic">
                ...
                <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs text-gray-800 text-center md:text-left">
